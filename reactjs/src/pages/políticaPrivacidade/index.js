...
export default function PolíticaDePrivacidade(){
    return(
        
        <PContainer>
            <Cabecalho/>
                <div className = "PConteudo">
                    <div className = "PTitulo">Política de Privacidade</div>
            
A sua privacidade é importante para nós. É política da Enlox respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site Enlox, e outros sites que possuímos e operamos.
...
O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Enlox oferece no site e com caráter enunciativo, mas não limitativo:
...
C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Enlox, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.
Mais informações
